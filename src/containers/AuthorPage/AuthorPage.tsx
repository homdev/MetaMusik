...
const AuthorPage: FC<AuthorPageProps> = ({ className = "" }) => {
  ...
  return (
    <div className={`nc-AuthorPage  ${className}`} data-nc-id="AuthorPage">
      <Helmet>
        <title>Creator || MetaMusik NFT Template</title>
      </Helmet>
        ...
        <div className="container -mt-10 lg:-mt-16">
          <div className="relative bg-white dark:bg-neutral-900 dark:border dark:border-neutral-700 p-5 lg:p-8 rounded-3xl md:rounded-[40px] shadow-xl flex flex-col md:flex-row">
            <div className="w-32 lg:w-44 flex-shrink-0 mt-12 sm:mt-0">
              <NcImage
                src="https://www.booska-p.com/wp-content/uploads/2022/06/Naps-Visu-News.jpg"
            ...
            <div className="pt-5 md:pt-1 md:ml-6 xl:ml-14 flex-grow">
              <div className="max-w-screen-sm ">
                ...
                Bienvenue sur mon profil Okey! Vous trouverez ici toutes mes collections exclusives de NFT musicaux, 
                ainsi que des accès privés à des concerts inédits. Restez à l'affût, 
                car de nouvelles nouveautés arrivent bientôt ! Okay.
                </span>
              </div>
              <div className="mt-4 ">
